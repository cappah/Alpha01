...
namespace gearengine
{
	namespace graphics
	{
		...
		bool GTexture::loadTexture2D(std::string a_sPath, bool bGenerateMipMaps)
		{
		...
		void GTexture::setFiltering(int a_tfMagnification, int a_tfMinification)
		{
		...
		void GTexture::bindTexture(int iTextureUnit)
		{
		...
		void GTexture::releaseTexture()
		{
			glDeleteSamplers(1, &uiSampler);
			glDeleteTextures(1, &uiTexture);
		}

		int GTexture::getMinificationFilter()
		{
			return tfMinification;
		}

		int GTexture::getMagnificationFilter()
		{
